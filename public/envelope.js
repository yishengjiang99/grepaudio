...
Envelope.prototype.trigger = function(param,time){
...
Envelope.prototype.release = function(param,time){
	this.releaseTime = time > this.sustainTime ? time : this.sustainTime;
	this.param.setTargetAtTime(this.minValue, this.releaseTime,this.releaseTimeConstant);
}


function createPacket(context) {
