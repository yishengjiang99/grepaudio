...
window.onkeydown = (e) => {
  switch (e.target.key) {
    case "up":
    case "w":
      moving = moveBoombox("up");
      break;
    case "down":
    case "d":
      moving = moveBoombox("down");
      break;
    case "left":
    case "a":
      moving = moveBoombox("left");
      break;
    case "right":
    case "f":
      moving = moveBoombox("right");
      break;
    case "q":
      moving = moveBoombox("rotate-right");
      break;
    case "e":
      moving = moveBoombox("rotate-left");
  }
};
...
const eqselect = document.querySelector(".modelFN");
const powerButton = document.querySelector(".control-power");

eqselect.oninput = function (e) {
  panner.panningModel = e.target.value;
};
